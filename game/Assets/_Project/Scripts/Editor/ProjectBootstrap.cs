        ...
        private static void MigrateLaboratoryScene()
        {
            ...
            var hasLaboratoryMissionEquipment = sceneText.Contains(
                ...
                sceneText.Contains(
                    ...
                    StringComparison.Ordinal);
            var hasQuarantineMissions = sceneText.Contains(
                "m_Name: WireConnect_QuarantineA",
                StringComparison.Ordinal);
            var hasQuarantineMissionEquipment = sceneText.Contains(
                "m_Name: '[Art] QuarantineAMissionEquipment'",
                StringComparison.Ordinal) &&
                sceneText.Contains(
                    "m_Name: '[Art] QuarantineBMissionEquipment'",
                    StringComparison.Ordinal);
            var hasWardStorageMissions = sceneText.Contains(
                "m_Name: IvDrip",
                StringComparison.Ordinal) &&
                sceneText.Contains(
                    "m_Name: RotateValve",
                    StringComparison.Ordinal);
            var hasWardStorageMissionEquipment = sceneText.Contains(
                "m_Name: '[Art] WardMissionEquipment'",
                StringComparison.Ordinal) &&
                sceneText.Contains(
