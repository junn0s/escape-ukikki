...
{
    /// <summary>
    /// 퓨즈 교체 미션의 상자형 임시 UI다(GDD §10.2).
    /// 탄 퓨즈 박스를 뽑아내고, 새 퓨즈 박스를 꽂는다.
    /// </summary>
    public sealed class FuseSwapView : MonoBehaviour
    {
        ...
        public void Configure(FuseSwapStation station, GameObject localPlayer)
        {
            Unsubscribe();
            _station = station;
