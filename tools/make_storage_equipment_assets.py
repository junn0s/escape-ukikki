#!/usr/bin/env python3
"""Prepare transparent RX-9 refrigerated storage props and a QA sheet."""
...
ASSET_SPECS = {
    "S_CryoTank.png": ((320, 448), (16, 18)),
    "S_SampleDrum.png": ((384, 384), (18, 18)),
    "S_FrozenPipe.png": ((128, 768), (8, 20)),
    "S_TemperatureTerminal.png": ((256, 448), (14, 18)),
    "S_CoolantManifold.png": ((192, 512), (12, 18)),
}


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser()
    parser.add_argument("--tank-source", type=Path, required=True)
    parser.add_argument("--drum-source", type=Path, required=True)
    parser.add_argument("--pipe-source", type=Path, required=True)
    parser.add_argument("--terminal-source", type=Path, required=True)
    parser.add_argument("--manifold-source", type=Path, required=True)
...
def make_preview(
    ...
    placements = {
        "S_CryoTank.png": ((80, 110), (320, 448)),
        "S_SampleDrum.png": ((450, 150), (360, 360)),
        "S_TemperatureTerminal.png": ((900, 80), (250, 438)),
        "S_FrozenPipe.png": ((1230, 80), (128, 768)),
        "S_CoolantManifold.png": ((1480, 180), (192, 512)),
    }
    draw_shadow(canvas, (45, 75, 435, 590), 52)
    draw_shadow(canvas, (415, 115, 845, 545), 55)
    draw_shadow(canvas, (865, 45, 1185, 555), 48)
    draw_shadow(canvas, (1195, 45, 1395, 885), 42)
    draw_shadow(canvas, (1440, 145, 1710, 730), 46)
...
def main() -> None:
    args = parse_args()
    sources = {
        "S_CryoTank.png": args.tank_source,
        "S_SampleDrum.png": args.drum_source,
        "S_FrozenPipe.png": args.pipe_source,
        "S_TemperatureTerminal.png": args.terminal_source,
        "S_CoolantManifold.png": args.manifold_source,
    }
    sprites = {
