#!/usr/bin/env python3
"""Prepare transparent RX-9 ward equipment and a visual QA sheet."""
...
ASSET_SPECS = {
    "S_HospitalBed.png": ((512, 256), (18, 16)),
    "S_CurtainRail.png": ((1024, 64), (14, 5)),
    "S_IvStand.png": ((384, 384), (18, 18)),
    "S_MedicalMonitor.png": ((384, 384), (18, 18)),
}


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser()
    parser.add_argument("--bed-source", type=Path, required=True)
    parser.add_argument("--curtain-source", type=Path, required=True)
    parser.add_argument("--iv-source", type=Path, required=True)
...
def make_preview(
    ...
    placements = {
        "S_HospitalBed.png": ((55, 70), (720, 360)),
        "S_MedicalMonitor.png": ((1030, 70), (360, 360)),
        "S_IvStand.png": ((100, 450), (360, 360)),
        "S_CurtainRail.png": ((520, 650), (900, 56)),
    }
    draw_shadow(canvas, (30, 45, 800, 455), 55)
    draw_shadow(canvas, (1005, 45, 1415, 455), 55)
    draw_shadow(canvas, (75, 425, 485, 835), 60)
    draw_shadow(canvas, (495, 620, 1445, 740), 40)
...
def main() -> None:
    args = parse_args()
    sources = {
        "S_HospitalBed.png": args.bed_source,
        "S_CurtainRail.png": args.curtain_source,
        "S_IvStand.png": args.iv_source,
        "S_MedicalMonitor.png": args.monitor_source,
    }
    sprites = {
