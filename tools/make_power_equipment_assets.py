#!/usr/bin/env python3
"""Prepare transparent RX-9 power-room equipment and a visual QA sheet."""
...
ASSET_SPECS = {
    "S_Generator.png": ((384, 512), (18, 20)),
    "S_BreakerBank.png": ((512, 256), (20, 16)),
    "S_CableReel.png": ((384, 384), (18, 18)),
    "S_BackupCellRack.png": ((512, 256), (20, 16)),
}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--breaker-source", type=Path, required=True)
    parser.add_argument("--reel-source", type=Path, required=True)
    parser.add_argument("--cell-rack-source", type=Path, required=True)
...
def build_background(
    ...
    canvas.alpha_composite(Image.new("RGBA", canvas.size, (5, 12, 18, 72)))
    return canvas
...
def make_preview(
    ...
    placements = {
        "S_Generator.png": ((75, 75), (360, 480)),
        "S_BreakerBank.png": ((500, 120), (640, 320)),
        "S_CableReel.png": ((390, 500), (340, 340)),
        "S_BackupCellRack.png": ((790, 535), (640, 320)),
    }
    draw_shadow(canvas, (50, 50, 455, 580), 55)
    draw_shadow(canvas, (475, 95, 1165, 465), 55)
    draw_shadow(canvas, (365, 475, 755, 865), 65)
    draw_shadow(canvas, (765, 510, 1455, 875), 55)
...
def main() -> None:
    args = parse_args()
    sources = {
        "S_Generator.png": args.generator_source,
        "S_BreakerBank.png": args.breaker_source,
        "S_CableReel.png": args.reel_source,
        "S_BackupCellRack.png": args.cell_rack_source,
    }
    sprites = {
