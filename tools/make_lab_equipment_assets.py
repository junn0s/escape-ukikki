#!/usr/bin/env python3
"""Prepare transparent RX-9 lab equipment and a visual QA sheet."""
...
ASSET_SPECS = {
    "S_Centrifuge.png": ((384, 384), (18, 18)),
    "S_Microscope.png": ((384, 320), (18, 16)),
    "S_PharmaFridge.png": ((256, 512), (16, 20)),
    "S_BiosafetyHood.png": ((320, 512), (18, 20)),
}


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser()
    parser.add_argument("--centrifuge-source", type=Path, required=True)
    parser.add_argument("--microscope-source", type=Path, required=True)
    parser.add_argument("--fridge-source", type=Path, required=True)
    parser.add_argument("--hood-source", type=Path, required=True)
...
def make_preview(
    ...
    placements = {
        "S_Centrifuge.png": ((55, 420), (360, 360)),
        "S_Microscope.png": ((420, 475), (384, 320)),
        "S_PharmaFridge.png": ((835, 90), (240, 480)),
        "S_BiosafetyHood.png": ((1130, 90), (300, 480)),
    }
    draw_shadow(canvas, (35, 400, 435, 800), 70)
    draw_shadow(canvas, (400, 455, 825, 820), 65)
    draw_shadow(canvas, (815, 70, 1095, 590), 55)
    draw_shadow(canvas, (1110, 70, 1450, 590), 55)
...
def main() -> None:
    args = parse_args()
    sources = {
        "S_Centrifuge.png": args.centrifuge_source,
        "S_Microscope.png": args.microscope_source,
        "S_PharmaFridge.png": args.fridge_source,
        "S_BiosafetyHood.png": args.hood_source,
    }
    sprites = {
